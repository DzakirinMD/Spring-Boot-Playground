...
public class CustomerServiceTest {
    ...
    public void testGetAllCustomers() {
        ...
        sampleCustomers.add(new Customer(1L, "frank", "frank@gmail.com", LocalDate.of(1992, APRIL, 3)));
        sampleCustomers.add(new Customer(2L,"milly", "milly@gmail.com", LocalDate.of(1990, JANUARY, 25)));

        List<CustomerDTO> expected = new ArrayList<>();
        expected.add(new CustomerDTO(1L, "frank"));
        expected.add(new CustomerDTO(2L, "milly"));
    ...
    public void testGetCustomer_ValidId() {
        // Given
        Customer sampleCustomer = new Customer("frank", "frank@gmail.com", LocalDate.of(1992, APRIL, 3));
        CustomerDTO expected = new CustomerDTO(1L, "frank");
